...
const Card = ({ title, subtitle, iconPath }) => {
	return (
		<div className="relative border border-gray-900 bg-black px-10 lg:px-16 mb-10 lg:mb-0 block h-74 lg:h-48 w-full hover:border-white focus:border-white focus:outline-none transition-all ease-in duration-200">
